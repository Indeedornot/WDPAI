    ...
    defineComponentSerializer({
      ...
      deserialize: (data) => 
      {
        ...
        return new SpriteRenderer2D({
          ...
          shape: SnapshotRead.string(rec['shape'], 'rect') as any,
          strokeColor: SnapshotRead.string(rec['strokeColor'], 'rgba(255,255,255,0.85)'),
          strokeWidth: SnapshotRead.number(rec['strokeWidth'], 2),
          label: SnapshotRead.string(rec['label'], ''),
          labelColor: SnapshotRead.string(rec['labelColor'], 'rgba(0,0,0,0.86)'),
        });
      },
    }),
    defineComponentSerializer({
