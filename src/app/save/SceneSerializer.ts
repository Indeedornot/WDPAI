...
export class SceneSerializer {
  ...
  restore(scene: Scene, snapshot: SceneSnapshotV1): void {
    ...
    const linkQueue: Array<{ component: Component; serializer: ComponentSerializer<any>; data: unknown }> = []
    for (const o of snapshot.objects) {
  ...
  private deserializeComponent(snapshot: ComponentSnapshot): { component: Component | null; serializer: ComponentSerializer<any> | null } {
